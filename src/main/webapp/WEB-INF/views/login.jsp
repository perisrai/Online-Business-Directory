	                            ...
	                            <div class="form-bottom">
				                    <form  action="login" method="post" class="login-form">
				                    	<div class="form-group">
				                        	...
				                        	<input type="text" name="busername" placeholder="Username..." class="busername form-control" id="busername">
				                        </div>
				                        <div class="form-group">
				                        	<label class="sr-only" for="bpassword">Password</label>
				                        	<input type="password" name="bpassword" placeholder="Password..." class="bpassword form-control" id="bpassword">
				                        </div>
